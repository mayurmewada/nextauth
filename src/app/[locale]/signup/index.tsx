            ...
            <div className="flex flex-col gap-5">
                <div className="md:flex md:items-center mb-6">
                        ...
                        <div className="md:w-2/3">
                            <input onChange={handleOnChange} className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-[#a69cac]" id="inline-username" type="text" placeholder="janedoe" />
                        </div>
                    </div>
                <div className="md:flex md:items-center mb-6">
                        <div className="md:w-1/3">
                        ...
                        <div className="md:w-2/3">
                            <input onChange={handleOnChange} className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-[#a69cac]" id="inline-email" type="email" placeholder="janedoe@mailprovider.com" />
                        </div>
                    </div>
                    <div className="md:flex md:items-center mb-6">
                        <div className="md:w-1/3">
